...
** *Statut* : L’état actuel d’une tâche peut être Actif ou Inactif. Les tâches utilisant des chemins d’exportation manuels dont le statut est invalide ou désactivé deviennent automatiquement inactives. Consultez link:manage-file-servers.html["Ajoutez et gérez des serveurs de fichiers dans NetApp Data Migrator"] pour plus de détails.
